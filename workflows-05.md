...
# wrangler.toml
[vars]
BOOTSTRAP_ADMIN_EMAIL = "email.do.admin@unieuro.com.br"
```
...
```
Nome,Email,Data,Entrada,Saída,Horas Trabalhadas,Observação
João Silva,joao@unieuro.com.br,05/03/2025,08:02,17:15,9h 13min,
Maria Santos,maria@unieuro.com.br,05/03/2025,,,0h 0min,Justificativa aprovada: consulta médica
```
