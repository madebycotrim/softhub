                        ...
                        <div className="flex gap-1">
                            {Object.entries(LABELS_PRIORIDADE).map(([key, label]) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-tight transition-all ${prioridadeFiltro.includes(key)
                ...
                <div className="flex items-center gap-2 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0 scrollbar-none">
                    ...
                    {Object.entries(LABELS_STATUS).map(([key, label]) => (
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-tight transition-all shrink-0 ${statusFiltro.includes(key)
